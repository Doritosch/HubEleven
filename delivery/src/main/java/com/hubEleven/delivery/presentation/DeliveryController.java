...
public class DeliveryController {
    ...
    public ResponseEntity<ApiResponse<CommonPageResponse<DeliveryResponseDto>>> searchDelivery(
        ...
        Page<DeliveryResponseDto> result = deliveryService.searchDelivery(
                deliveryId, orderId, status, fromHubId, toHubId, recipientName,
                recipientSlackId, deliveryManagerId, page, size, sort
        );
